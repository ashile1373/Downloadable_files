...
import ir.ashilethegreat.payesh.Adapters.TransferDonePlansRecyclerViewAdapter;
...
public class TransferDonePlansFragment extends Fragment {
    ...
    TransferDonePlansRecyclerViewAdapter adapter;
    ...
    public TransferDonePlansFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_transfer_done_plans, container, false);
        ...
        toEnd.setOnClickListener(v -> transferPlansRecyclerView.smoothScrollToPosition(0));
...
//                    }
        ...
        searchedContentsClose.setOnClickListener(v -> {
            ...
            adapter = new TransferDonePlansRecyclerViewAdapter(planList, senderUserList, receiverUserList, counselingModalArrayList, cultivationModalArrayList,
...
//        titleText.setText(title);
    ...
    private void loadPlans(JSONObject jsonBody) {
        ...
        JsonObjectRequest jsonRequest1 = new JsonObjectRequest(Request.Method.POST, getString(R.string.URLTransferDonePlanList), jsonBody,
                response -> {
                    try {
                        if (response.getString("status").equals("Token is Expired")) {
                            ...
                            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(requireActivity());
                            linearLayoutManager.setReverseLayout(true);
                            transferPlansRecyclerView.scrollToPosition(planList.size() - 1);
                            transferPlansRecyclerView.setLayoutManager(linearLayoutManager);
                            transferPlansRecyclerView.setAdapter(adapter);
                        }
                    } catch (JSONException e) {
